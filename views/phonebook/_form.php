...
<div class="phonebook-form" >
    ...
    <?= $form->field($model, 'surname')->textInput(['maxlength' => true, 'required'=> true]) ?>

    <?= $form->field($model, 'patronymic')->textInput(['maxlength' => true, 'required'=> true]) ?>

    <?= $form->field($model, 'mobile')->textInput(['maxlength' => true, 'required'=> true]) ?>

    <?= $form->field($model, 'home')->textInput(['maxlength' => true, 'required'=> true]) ?>
